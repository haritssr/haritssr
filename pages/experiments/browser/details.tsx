  ...
  return (
    <LayoutToExperiments title='Details' domain='Browser'>
      <SubTitle>
        ...
        <br />
        If you are using google translate extention in chrome and twicely click the details tag and
        content of summary tag, the text will selected and get weirdly translated.
        <br />I prefer Headless UI or Radix UI similar UI component than this weird native API.
      </SubTitle>
