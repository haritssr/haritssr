		...
		<LayoutToExperiments title="Sidebar Hieararchy" domain="Haris Lab">
			<div className="space-y-5 sm:w-2/5">
				{PhysicsHierarchyData.map((domain) => (
					<details key={domain.domain_title} aria-label="domain-area" className="bg-red-100 p-1 ">
						...
						<div aria-label="chapter-area" className="bg-yellow-100 p-1 space-y-2">
							{domain.chapters.map((chapter) => (
								<details key={chapter.chapter_title} className="bg-green-100 p-1" aria-label="materi-area">
									<summary>
										<Link href={chapter.chapter_title} aria-label="chapter-title" className="hover:underline">
