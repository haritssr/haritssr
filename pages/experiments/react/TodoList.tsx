...
export default function TodoList() {
  ...
  const inputStyle =
    'px-2.5 py-2 xs:py-1.5 placeholder-gray-400 rounded-md shadow focus:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset hover:shadow-md caret-orange-500 caret focus:shadow-none';
  ...
  return (
    <LayoutSubWorkToTopic title='Todo List' href='/work/react' hrefName='React'>
      <SubTitle>Simple todo list</SubTitle>
      <form
        action=''
      ...
      <ul className='mt-5 space-y-2 list-decimal list-inside'>
        {todos.map(todo => (
          <li key={todo.id}>
