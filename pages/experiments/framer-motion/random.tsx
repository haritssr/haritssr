  ...
  return (
    <LayoutToExperiments domain='Framer Motion' title='Random'>
      <div className='space-y-10'>
        ...
        <motion.div drag='x' style={{ x, opacity }} className='h-10 w-10 bg-blue-500'></motion.div>
...
const Propagation = () => {
  ...
  return (
    <motion.ul initial='hidden' animate='visible' variants={list} className='space-y-2'>
