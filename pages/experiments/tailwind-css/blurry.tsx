      ...
      <div>
        <div className='border border-zinc-300 p-3'>
          <div className='relative w-full max-w-lg'>
            <div className='absolute top-0 -left-4 h-24 w-24 animate-blob rounded-full bg-pink-300/70 mix-blend-multiply blur-lg sm:h-72 sm:w-72'></div>

            <div className='animation-delay-2000 absolute top-0 -right-4 h-24 w-24 animate-blob rounded-full bg-blue-300/70 mix-blend-multiply blur-lg sm:h-72 sm:w-72'></div>

            <div className='animation-delay-4000 absolute top-0 -bottom-8 left-28 h-24 w-24 animate-blob rounded-full bg-green-300/70 mix-blend-multiply blur-lg sm:h-72 sm:w-72'></div>
