    ...
    <LayoutToExperiments title='Grid' domain='Tailwind CSS'>
      ...
      <div className='grid min-h-screen place-items-center '>
        <div className='grid max-w-5xl gap-4 xs:grid-cols-2 md:grid-cols-4 '>
          ...
          <div className='xs:square h-16 bg-blue-500 xs:h-auto'></div>
          <div className='xs:square h-16 bg-blue-500 xs:h-auto'></div>
          <div className='xs:square h-16 bg-pink-500 xs:h-auto'></div>
          <div className='xs:square h-16 bg-blue-500 xs:h-auto md:col-start-2'></div>
          <div className='xs:square h-16 bg-pink-500 xs:h-auto'></div>
          <div className='xs:square h-16 bg-blue-500 xs:h-auto'></div>
          <div className='xs:square h-16 bg-blue-500 xs:h-auto'></div>
          <div className='xs:square h-16 bg-pink-500 xs:h-auto'></div>
