      ...
      <form action=''>
        ...
        >
          <Slider.Track
            ...
            className='h-2 flex-1 rounded-full bg-zinc-700 shadow'
          >
            <Slider.Range className='rounded-ful absolute h-full bg-white' />
          </Slider.Track>
          <Slider.Thumb className='block h-5 w-5 rounded-full border border-zinc-300 bg-white shadow-lg focus:border focus:border-zinc-500 focus:outline-none focus:ring-4 focus:ring-zinc-400/50' />
        </Slider.Root>
      </form>
    </LayoutToExperiments>
  );
