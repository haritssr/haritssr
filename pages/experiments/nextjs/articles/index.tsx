...
export async function getStaticProps() {
	...
	const posts = await fetch("https://jsonplaceholder.typicode.com/posts/?_limit=20").then((post) => post.json());
	return {
		props: {
			posts,
		},
	...
	return (
		<LayoutToExperiments title="Articles " domain="Nextjs">
			<SubTitle>
				...
				<ExternalLink name="json placeholder" href="https://jsonplaceholder.typicode.com/posts" /> using
				<ExternalLink name="getStaticProps" href="https://nextjs.org/docs/basic-features/data-fetching/get-static-props" />
				and populated to new page for each article using
				<ExternalLink name="getStaticPaths" href="https://nextjs.org/docs/basic-features/data-fetching/get-static-paths" />
			</SubTitle>
