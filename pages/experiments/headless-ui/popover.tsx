		...
		<Popover className='relative'>
			...
			<Popover.Panel className='absolute w-fit mt-2 shadow-lg'>
				<div className='divide-y divide-zinc-200 rounded-md overflow-hidden text-zinc-800 bg-white border border-zinc-400'>
					<div className='px-3 py-2 hover:bg-zinc-50 cursor-pointer'>Experiments</div>
					<div className='px-3 py-2 hover:bg-zinc-50 cursor-pointer'>Blog</div>
					<div className='px-3 py-2 hover:bg-zinc-50 cursor-pointer'>Articles</div>
					<div className='px-3 py-2 hover:bg-zinc-50 cursor-pointer'>Case Studies</div>
				</div>
			</Popover.Panel>
		</Popover>
	);
