...
const ExportedComboboxExperimentsData = () => {
	return (
		<LayoutToExperiments
			title="Combobox - Experiments Data"
			domain="Headless UI"
		>
			<SubTitle>
				<ExternalLink
				...
				<ExplanationList>
					...
					<li>
						The idea is this search box can be used to searching all my entire
						experiments in this site.
					</li>
				</ExplanationList>
			</SubTitle>
				...
				>
					...
					>
						...
						{filteredExperimentsData.length > 0 && (
							...
							>
								{filteredExperimentsData.map(
									(ExperimentData: filteredExperimentsDataType) => (
										<Combobox.Option
