...
import { projects } from '../../../data/projectsDataCombobox.js';
...
const ImportedCombobox = () => {
  return (
    <LayoutToExperiments title='Combobox' domain='Headless UI'>
      <SubTitle>
      ...
      <ComboboxExample1 projects={projects} />
    </LayoutToExperiments>
  );
};
  ...
  return (
    <Transition.Root show={isOpen} as={Fragment} afterLeave={() => setQuery('')}>
      ...
      >
        ...
        >
          <Combobox
            // yang akan terjadi ketika klik pilihan di bawah combobox
            onChange={project => {
              setIsOpen(false);
