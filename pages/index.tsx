    ...
    >
      <section className='mx-auto flex flex-col sm:mx-0 sm:mr-10  sm:px-0 sm:pl-4'>
        ...
        <article className='space-y-2 text-center sm:text-left'>
          ...
          <div className='flex items-center space-x-1 text-lg font-medium text-zinc-500'>
            ...
            >
              <LocationMarkerIcon className='h-4 w-4 text-rose-600 hover:ring-1 hover:ring-rose-300' />
            </a>
          </div>
          <div className='text-lg font-medium text-zinc-500'>Web Frontend React Engineer</div>
...
const TechStack = () => {
  return (
    <Wrapper
      id='TechStack'
      topic='Tech Stack'
      className='grid grid-flow-row grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4 md:grid-cols-4'
    >
