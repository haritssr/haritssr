...
export default function Glowing() {
  return (
    <LayoutSubWorkToTopic title='Glowing' href='/work/tailwindcss' hrefName='Tailwind CSS'>
      <SubTitle>
        Beautiful background glowing effect from Linear. See that the background is animated spin
      </SubTitle>
