...
export default function ExperimentCard({ experiment }: { experiment: ExperimentsData }) {
	return (
		<Link
			...
			key={experiment.id}
			className="space-y-1 px-3 py-2.5 hover:bg-zinc-50 dark:bg-zinc-800 dark:hover:bg-zinc-700/60 border border-zinc-300 dark:border-zinc-700 rounded-lg group"
		>
