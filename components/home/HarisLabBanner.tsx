export default function HarisLabBanner() {
	return (
		<div className=" border border-blue-300 rounded-lg p-4 space-y-3">
			...
			<a
				...
				target="_blank"
				className="block w-full sm:w-fit hover:bg-[#2563eb]/90 bg-blue-600 text-white py-2 sm:py-1.5 sm:px-3 rounded-md text-center"
			>
				Take A Look
			</a>
		</div>
