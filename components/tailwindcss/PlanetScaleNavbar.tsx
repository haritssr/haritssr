...
export default function PlanetScaleNavBar() {
  return (
    <div>
      <Topic name='PlanetScale Navigation Bar' />
      <SubTopic>
        <a
      ...
      <div className='p-3 border border-zinc-300'>
        <div className='bg-[#1a1b21] rounded-md py-6 md:pr-4 md:py-4 px-6 w-full h-auto flex flex-col md:flex-row md:items-center items-start justify-between text-tiny space-y-5 md:space-y-0'>
