...
export default function DialogButton({
	...
	return (
		<div className="my-5">
			...
			<Dialog open={isOpen} onClose={() => setIsOpen(false)} className="fixed inset-x-0 top-[25vh] z-40 mx-auto h-fit w-[90%] sm:w-1/3">
				...
				<Dialog.Panel className="relative z-50 rounded-xl bg-white p-5 shadow-xl">
					<div className="mb-3 flex items-center justify-between  ">
						<div className="w-fit rounded-full bg-blue-100 px-3 pb-1 pt-1.5 text-[13px] font-medium text-blue-700">Reading</div>
