      ...
      <div className='mx-auto flex h-11 max-w-4xl flex-row justify-between px-3 py-2 xl:px-0'>
        ...
        <div className='hidden sm:block'>
          <section className='flex flex-row items-center space-x-5  sm:space-x-8'>
            ...
            >
              <svg
                className='h-5 w-5 text-zinc-400 hover:text-zinc-300'
        ...
        <div className='flex items-center space-x-2 sm:hidden'>
          ...
          >
            <svg
              className='h-5 w-5 text-zinc-300 hover:text-zinc-300 sm:text-zinc-400'
              viewBox='0 0 1024 1024'
              fill='currentColor'
              xmlns='http://www.w3.org/2000/svg'
            >
          ...
          <Link href='/#contacts'>
            <a className='flex items-center rounded-full bg-zinc-300 px-2 py-1 text-[12px] font-medium text-zinc-800'>
              Contact me
            </a>
          </Link>
        </div>
