    ...
    <nav className='z-30 bg-zinc-800'>
      <div className='mx-auto flex h-12 max-w-4xl flex-row items-center justify-between px-3 py-2 xl:px-0'>
        ...
        <div className='flex items-center space-x-2 sm:hidden'>
          ...
          <Link href='/#contacts'>
            <a className='flex items-center rounded-full bg-zinc-300 px-3 py-1 text-[12px] font-medium text-zinc-800'>
              Contact Me
            </a>
          </Link>
        </div>
...
const GitHubLinkWithIcon = () => {
  return (
    ...
    >
      <svg
        className='h-5 w-5 text-zinc-300 hover:text-zinc-100 sm:text-zinc-400'
