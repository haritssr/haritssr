      ...
      <div className='grid grid-cols-1 gap-3 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-2'>
        ...
        <Box href='https://www.github.com/haritssr'>
          <div className='flex items-center space-x-3'>
            ...
            <div className='font-medium text-gray-600 truncate text-tiny'>github/haritssr</div>
          </div>
        </Box>
        ...
        <Box href='https://www.twitter.com/haritssr'>
          <div className='flex items-center space-x-3'>
            <TwitterSVG />
            <div className='font-medium text-gray-600 truncate text-tiny'>@haritssr</div>
          </div>
        </Box>
        ...
        <a
          ...
          target='_blank'
          rel='noreferrer'
          className='flex items-center justify-between w-auto px-3 py-2.5 sm:py-2 space-x-2 duration-200 ease-out bg-white rounded-lg shadow hover:shadow-lg group'
        >
          <div className='flex items-center space-x-3 overflow-hidden'>
            ...
            <div className='font-medium text-gray-600 truncate text-tiny'>haritssr@gmail.com</div>
          </div>
        ...
        <Box href='https://www.haritssr.com'>
          <div className='flex items-center space-x-3'>
            ...
            <div className='font-medium text-gray-600 truncate text-tiny'>haritssr.com</div>
          </div>
        </Box>
      </div>
    </div>
