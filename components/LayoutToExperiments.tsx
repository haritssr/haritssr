    ...
    <>
      ...
      <main className="mx-auto flex max-w-5xl sm:mt-10 sm:gap-10 sm:px-5 xl:px-0">
        ...
        <article className="mx-auto min-h-screen w-full max-w-4xl sm:w-3/4 sm:px-0">
          {/* Navigation */}
          <div
            className={`sticky -top-0 sm:top-20 border-b ${
          ...
          <div className="px-5 sm:px-0">
            <div className="mt-5 mb-4 w-fit rounded-full border border-zinc-300 px-3 pb-0.5 pt-1 text-xs text-zinc-800 sm:mt-10">
              {domain}
            </div>
            <h1
