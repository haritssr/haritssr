        ...
        {({ open }) => (
          <>
            <Disclosure.Button
              className={`${
                open ? 'rounded-b-none ' : ''
              } w-full rounded-lg flex flex-row items-center justify-between py-2 px-3 border border-gray-400  cursor-pointer focus:outline-none  bg-gray-200 font-medium text-gray-700 hover:bg-gray-300`}
            >
              Disclosure Button
              <ChevronDown
            ...
            <Disclosure.Panel className='p-3 text-gray-600 border border-t-0 border-gray-400 rounded-b-lg '>
