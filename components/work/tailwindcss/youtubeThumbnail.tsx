  ...
  return (
    <div className='w-[640px] h-[360px] bg-white relative overflow-hidden'>
      ...
      <div className='relative flex flex-col justify-end w-2/3 h-full p-8 space-y-4'>
        ...
        <h1 className='text-4xl font-semibold text-gray 900'>YoutubeThumbail with Tailwind CSS</h1>
        <TailwindSVG />
      </div>
    </div>
  );
...
const Play = () => {
  return (
    <svg
      ...
      className='absolute w-[200px] h-[200px] -top-14 -left-14 text-purple-400'
      viewBox='0 0 20 20'
      fill='currentColor'
    >
      <path
...
const PlayButton = () => {
  return (
    <svg
      className='w-[64px] h-[72px] text-white'
      viewBox='0 0 24 24'
      width='24'
      height='24'
      stroke='currentColor'
...
const TailwindSVG = () => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 262 33' className='w-36'>
