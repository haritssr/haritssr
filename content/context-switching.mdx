...
topic: Humanity
notionPageId: 3059ba5e-fe15-812c-a91a-f72c6ea8742e
---
...
Flow is the absence of context
...
- **[How to manage your time more effectively (according to machines) - Brian Christian](https://www.youtube.com/watch?v=iDbdXTMnOmE)**
  ...
  - Productivity vs Responsiveness
    <aside className="text-action border border-zinc-500 px-4 rounded-md">
    	(these two principle fundamentaly in tension, recognizing this tension allow us to decide where we want to stike that balance)
    </aside>
